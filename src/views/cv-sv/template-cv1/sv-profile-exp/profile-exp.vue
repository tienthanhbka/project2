<template>
  <div class="profile-exp" @click="selectItem">
  ...
  data() {
    return {
      ...
      ExpInfo: {
        TimeStart: "12/2020",
        TimeEnd: "Hiện tại",
        NameCompany: "Trường Đại học Bách Khoa Hà Nội",
        Position: "Sinh Viên",
        Detail:
  ...
  methods: {
    addItem() {
      this.lines.push({
        ...
        ID: "item",
        value: {
          TimeStart: this.ExpInfo.TimeStart,
          TimeEnd: this.ExpInfo.TimeEnd,
          NameCompany: this.ExpInfo.NameCompany,
          Position: this.ExpInfo.Position,
          Detail: this.ExpInfo.Detail
        }
      });
    },
    removeItem(index) {
